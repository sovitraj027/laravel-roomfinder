        ...
        <div class="card mb-2">
            <div class="card-body">
                <div class="row welcomecard">
                    <div class="col-12">
                        <h5 class="pb-2">Edit Testimonial</h5>

                        <form class="custom-hover" action="{{route('testimonial.update',$testimonial->id)}}" method="POST">
                            {{ csrf_field() }}
                            {{method_field('patch')}}
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" required placeholder="Title" name="title" value="{{$testimonial->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-12 p-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="article-ckeditor" name="description" rows="3" required>{{$testimonial->description}}</textarea>
                                    </div>
                                </div>
